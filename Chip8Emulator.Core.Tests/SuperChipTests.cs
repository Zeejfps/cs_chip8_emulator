...
public class SuperChipTests
{
    ...
    public void DisableHighResModeIns_SetsDisplayTo64x32()
    {
        ...
        emulator.ExecuteZeroBaseIns(0x00FE);
    ...
    public void ScrollDownIns_MovesPixelsDownByNRows()
    {
        ...
        emulator.ExeuteDrawToScreenIns(0xD001); // row 8 lit pixels at y=0

        emulator.ExecuteZeroBaseIns(0x00C3); // scroll down 3
    ...
    public void ScrollDownIns_ClearsTopNRows()
    {
        ...
        emulator.ExecuteZeroBaseIns(0x00C2);
    ...
    public void ScrollDownIns_WithZeroIsNoOp()
    {
        ...
        emulator.ExecuteZeroBaseIns(0x00C0);
    ...
    public void ScrollRightIns_MovesPixelsRightBy4()
    {
        ...
        emulator.WriteMemory(0x300, [0xFF]);
        emulator.ExecuteSetIndexRegisterIns(0xA300);
        emulator.ExeuteDrawToScreenIns(0xD001); // x=0..7 lit at y=0

        emulator.ExecuteZeroBaseIns(0x00FB);
    ...
    public void ScrollRightIns_PixelsFallingOffRightEdgeAreLost()
    {
        ...
        emulator.WriteMemory(0x300, [0xFF]);
        emulator.ExecuteSetIndexRegisterIns(0xA300);
        emulator.ExecuteSetRegisterValueIns(0x6038); // V0 = 56 -> sprite at x=56..63
        emulator.ExecuteSetRegisterValueIns(0x6100); // V1 = 0
    ...
    public void ScrollLeftIns_MovesPixelsLeftBy4()
    {
        ...
        emulator.WriteMemory(0x300, [0xFF]);
        emulator.ExecuteSetIndexRegisterIns(0xA300);
        emulator.ExecuteSetRegisterValueIns(0x6008); // V0 = 8
        emulator.ExecuteSetRegisterValueIns(0x6100); // V1 = 0
        emulator.ExeuteDrawToScreenIns(0xD011); // x=8..15 lit at y=0

        emulator.ExecuteZeroBaseIns(0x00FC);
    ...
    public void ScrollLeftIns_PixelsFallingOffLeftEdgeAreLost()
    {
        ...
        emulator.WriteMemory(0x300, [0xFF]);
        emulator.ExecuteSetIndexRegisterIns(0xA300);
        emulator.ExeuteDrawToScreenIns(0xD001); // x=0..7 at y=0
    ...
    {
        var emulator = CreateEmulator();
        emulator.ExecuteSetRegisterValueIns(0x6005); // V0 = 5
    ...
    {
        var emulator = CreateEmulator();
        emulator.ExecuteZeroBaseIns(0x00FF); // enable high-res
    ...
    public void DxY0_DrawsAtVxVyCoordinates()
    {
        ...
        emulator.WriteMemory(0x300, sprite);
        emulator.ExecuteSetIndexRegisterIns(0xA300);
        emulator.ExecuteSetRegisterValueIns(0x6314); // V3 = 20
        emulator.ExecuteSetRegisterValueIns(0x640A); // V4 = 10

        emulator.ExeuteDrawToScreenIns(0xD340);
    ...
    public void DxY0_ClipsAtBottomEdge()
    {
        ...
        emulator.ExecuteSetRegisterValueIns(0x6138); // V1 = 56 -> only 8 rows fit
    ...
    public void DxY0_ClipsAtRightEdge()
    {
        ...
        emulator.WriteMemory(0x300, sprite);
        emulator.ExecuteSetIndexRegisterIns(0xA300);
        emulator.ExecuteSetRegisterValueIns(0x6078); // V0 = 120 -> only 8 cols fit
        emulator.ExecuteSetRegisterValueIns(0x6100); // V1 = 0
    ...
    public void DxY0_NoCollisionClearsVf()
    {
        var emulator = CreateEmulator();
        emulator.ExecuteZeroBaseIns(0x00FF);
        emulator.ExecuteSetRegisterValueIns(0x6F01); // dirty VF
