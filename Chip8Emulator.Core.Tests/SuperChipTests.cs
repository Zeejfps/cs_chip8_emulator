...
public class SuperChipTests
{
    ...
    public void EnableHighResModeIns_SetsDisplayTo128x64()
    {
        ...
        cpu.SystemRoutines[0x00FF & 0x00FF](cpu, 0x00FF);
    ...
    public void DisableHighResModeIns_SetsDisplayTo64x32()
    {
        ...
        cpu.SystemRoutines[0x00FE & 0x00FF](cpu, 0x00FE);
    ...
    public void ScrollDownIns_MovesPixelsDownByNRows()
    {
        ...
        Chip8Routines.DrawToScreen(cpu, 0xD001); // row 8 lit pixels at y=0

        cpu.SystemRoutines[0x00C3 & 0x00FF](cpu, 0x00C3); // scroll down 3
    ...
    public void ScrollDownIns_ClearsTopNRows()
    {
        ...
        cpu.SystemRoutines[0x00C2 & 0x00FF](cpu, 0x00C2);
    ...
    public void ScrollDownIns_WithZeroIsNoOp()
    {
        ...
        cpu.SystemRoutines[0x00C0 & 0x00FF](cpu, 0x00C0);
    ...
    public void ScrollUpIns_MovesPixelsUpByNRows()
    {
        ...
        emulator.Memory.Write(0x300, [0xFF]);
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.SetRegisterValue(cpu, 0x6000); // V0 = 0
        Chip8Routines.SetRegisterValue(cpu, 0x6105); // V1 = 5 -> draw at y=5
        Chip8Routines.DrawToScreen(cpu, 0xD011);

        cpu.SystemRoutines[0x00D3 & 0x00FF](cpu, 0x00D3); // scroll up 3
    ...
    public void ScrollUpIns_ClearsBottomNRows()
    {
        ...
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.SetRegisterValue(cpu, 0x6000); // V0 = 0
        Chip8Routines.SetRegisterValue(cpu, 0x611F); // V1 = 31 -> bottom row of 64x32
        Chip8Routines.DrawToScreen(cpu, 0xD011);

        cpu.SystemRoutines[0x00D2 & 0x00FF](cpu, 0x00D2); // scroll up 2
    ...
    public void ScrollUpIns_WithZeroIsNoOp()
    {
        ...
        emulator.Memory.Write(0x300, [0xFF]);
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.DrawToScreen(cpu, 0xD001); // row of 8 lit at y=0

        cpu.SystemRoutines[0x00D0 & 0x00FF](cpu, 0x00D0);
    ...
    public void ScrollRightIns_MovesPixelsRightBy4()
    {
        ...
        emulator.Memory.Write(0x300, [0xFF]);
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.DrawToScreen(cpu, 0xD001); // x=0..7 lit at y=0
    ...
    public void ScrollRightIns_PixelsFallingOffRightEdgeAreLost()
    {
        ...
        emulator.Memory.Write(0x300, [0xFF]);
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.SetRegisterValue(cpu, 0x6038); // V0 = 56 -> sprite at x=56..63
        Chip8Routines.SetRegisterValue(cpu, 0x6100); // V1 = 0
        Chip8Routines.DrawToScreen(cpu, 0xD011);
    ...
    public void ScrollLeftIns_MovesPixelsLeftBy4()
    {
        ...
        emulator.Memory.Write(0x300, [0xFF]);
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.SetRegisterValue(cpu, 0x6008); // V0 = 8
        Chip8Routines.SetRegisterValue(cpu, 0x6100); // V1 = 0
        Chip8Routines.DrawToScreen(cpu, 0xD011); // x=8..15 lit at y=0

        cpu.SystemRoutines[0x00FC & 0x00FF](cpu, 0x00FC);
    ...
    public void ScrollLeftIns_PixelsFallingOffLeftEdgeAreLost()
    {
        ...
        emulator.Memory.Write(0x300, [0xFF]);
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.DrawToScreen(cpu, 0xD001); // x=0..7 at y=0
    ...
    {
        var (emulator, cpu) = CreateEmulator();
        Chip8Routines.SetRegisterValue(cpu, 0x6005); // V0 = 5

        cpu.UtilityRoutines[0xF030 & 0x00FF](cpu, 0xF030);

        // High-res font base 0x0A0, each glyph is 10 bytes -> 0xA0 + 5*10 = 0xD2
        Assert.Equal(0xA0 + 5 * 10, cpu.Registers.ReadI());
    }
    ...
    {
        var (emulator, cpu) = CreateEmulator();
        Chip8Routines.SetRegisterValue(cpu, 0x6200); // V2 = 0

        cpu.UtilityRoutines[0xF230 & 0x00FF](cpu, 0xF230);

        Assert.Equal(0xA0, cpu.Registers.ReadI());
    }
    ...
    {
        var (emulator, cpu) = CreateEmulator();
        cpu.SystemRoutines[0x00FF & 0x00FF](cpu, 0x00FF); // enable high-res
        ...
        Chip8Routines.DrawToScreen(cpu, 0xD000);
    ...
    public void DxY0_DrawsAtVxVyCoordinates()
    {
        ...
        emulator.Memory.Write(0x300, sprite);
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.SetRegisterValue(cpu, 0x6314); // V3 = 20
        Chip8Routines.SetRegisterValue(cpu, 0x640A); // V4 = 10

        Chip8Routines.DrawToScreen(cpu, 0xD340);
    ...
    public void DxY0_ClipsAtBottomEdge()
    {
        ...
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.SetRegisterValue(cpu, 0x6000); // V0 = 0
        Chip8Routines.SetRegisterValue(cpu, 0x6138); // V1 = 56 -> only 8 rows fit

        Chip8Routines.DrawToScreen(cpu, 0xD010);
    ...
    public void DxY0_ClipsAtRightEdge()
    {
        ...
        emulator.Memory.Write(0x300, sprite);
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.SetRegisterValue(cpu, 0x6078); // V0 = 120 -> only 8 cols fit
        Chip8Routines.SetRegisterValue(cpu, 0x6100); // V1 = 0
    ...
    public void DxY0_NoCollisionClearsVf()
    {
        var (emulator, cpu) = CreateEmulator();
        cpu.SystemRoutines[0x00FF & 0x00FF](cpu, 0x00FF);
        Chip8Routines.SetRegisterValue(cpu, 0x6F01); // dirty VF
    ...
    public void DxY0_VfIsNumberOfCollidingRows()
    {
        ...
        Assert.Equal(16, cpu.Registers.ReadV(0xF));
    }
    ...
    public void DxY0_VfCountsBottomClippedRows()
    {
        ...
        Chip8Routines.SetIndexRegisterIns(cpu, 0xA300);
        Chip8Routines.SetRegisterValue(cpu, 0x6000); // V0 = 0
        Chip8Routines.SetRegisterValue(cpu, 0x6138); // V1 = 56 -> 8 rows fit, 8 clipped

        Chip8Routines.DrawToScreen(cpu, 0xD010);

        // No on-screen collision (fresh display), but 8 rows clipped off the bottom.
        Assert.Equal(8, cpu.Registers.ReadV(0xF));
    }
