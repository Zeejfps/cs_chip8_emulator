...
public class DrawToScreenTests
{
    ...
    public void DrawsAtCoordinatesFromVxVy()
    {
        ...
        Chip8InstructionSet.DrawToScreen(emulator, 0xD231);
    ...
    public void ClipsAtBottomEdge()
    {
        ...
        Chip8InstructionSet.DrawToScreen(emulator, 0xD234);
    ...
    public void WrapsAtBothEdgesSimultaneouslyWhenSpritesWrapIsOn()
    {
        ...
        Chip8InstructionSet.DrawToScreen(emulator, 0xD232);
    ...
    public void WrappedPixelSetsCollisionVf()
    {
        ...
        Chip8InstructionSet.SetRegisterValue(emulator, 0x6240); // V2 = 64 -> wraps to 0
